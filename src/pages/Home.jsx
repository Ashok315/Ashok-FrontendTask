        ...
        <div className="md:px-[25px]">
            ...
            <div  className="homeRightSection rounded-md h-full mb-[8rem]">
                ...
                <div className="flex items-center justify-between py-[15px] text-dark border-spacing-0 border-b-[1.5px] border-b-gray-400">
                    <p className="border-spacing-0 border-b border-b-gray-600 text-[24px] font-semibold ms-[20px] font-open-sans">Calendar</p>

                    <div className="flex justify-between items-center gap-[12px] py-[2.5px]">
                        <img src="/lockIcon.svg" alt="" />
                        <p className="text-[16px]">Google Calendar</p>
                        {/* switch input */}
                        <div>
              ...
              {/* big calender and calender */}
                 <div className="flex gap-[5px]  items-start justify-between p-[10px] flex-col lg:flex-row">
                    {/* left */}
